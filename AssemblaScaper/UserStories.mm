...
<node CREATED="1351786258568" ID="ID_1787578124" MODIFIED="1352495558268" TEXT="Can create a new business containing all the objectives I have been delegated : Create New Plan [1.7]">
...
<node CREATED="1351786383114" ID="ID_1951101424" MODIFIED="1352495662366" TEXT="Must specify the category of each risk in my business plan : Risk Category [1.8]"/>
<node CREATED="1351786404085" ID="ID_1410849312" MODIFIED="1352495664015" TEXT="Must specify a threshold value for at least one risk impact category for each risk in my business plan : Risk Impact Threshold [1.9]"/>
<node CREATED="1351786489522" ID="ID_301233872" MODIFIED="1352495668302" TEXT="Can add a description of the existing controls and mitigating factors for each risk in my business plan : Risk Controls And Mitigating Factors [1.9]"/>
...
<node CREATED="1351786614068" ID="ID_1405258741" MODIFIED="1352495675204" TEXT="Can add cross-functional impacts to any supporting objectives in my business plan : Cross Functional Impacts [1.7]">
<node CREATED="1351786907805" ID="ID_232407877" MODIFIED="1352495688614" TEXT="Must add a description of the nature of each cross-functional impact I have created in my business plan : Nature Of Impact [1.13]"/>
...
<node CREATED="1351787001539" ID="ID_841752601" MODIFIED="1352495692430" TEXT="Can view the acceptance status of all the cross-functional impacts I have created in my business plan : Impact Acceptance Status [1.16]"/>
...
<node CREATED="1351868448009" ID="ID_482833495" MODIFIED="1352495700518" TEXT="Can update the expected completion date of any supporting objective in my business plan that I have not delegated when updating its status : Revise Completion Date During Status Update [1.15]"/>
...
<node CREATED="1352496165922" ID="ID_330474136" MODIFIED="1352496202097" TEXT="Can work on my quarterly status update in draft before submitting a final version : Draft Status Update [1.15]"/>
</node>
<node CREATED="1351786288124" ID="ID_1478012938" MODIFIED="1352495651247" TEXT="Can print a business plan : Print Plan [2.1]"/>
<node CREATED="1351786298160" ID="ID_951712756" MODIFIED="1352495654702" TEXT="Can print multiple business plans at once : Print Multiple Plans [2.1]"/>
</node>
<node CREATED="1351786245434" ID="ID_1034891542" MODIFIED="1352495568958" TEXT="Can view all the objectives that have been delegated to me : View Delegated Objectives [1.11]">
...
<node CREATED="1351785337904" ID="ID_1622483735" MODIFIED="1352495574524" TEXT="Can view a list of my notifications sorted by type : View Notifications">
...
<node CREATED="1351785892213" ID="ID_1184717163" MODIFIED="1352495623501" TEXT="Can work on my plan in draft without anyone being able to view it or sending out any notifications : Work On Plan While Hidden"/>
<node CREATED="1351785749649" ID="ID_396482319" MODIFIED="1352495610854" TEXT="Can publish my plan for other users to view : Publish Plan"/>
<node CREATED="1351785560088" ID="ID_350281933" MODIFIED="1352495594742" TEXT="Can edit my plan any time before final approval : Edit Plan Before Final Approval [1.2,1.3]"/>
<node CREATED="1351785615574" ID="ID_1048254944" MODIFIED="1352495603680" TEXT="Can submit my plan to my manager for approval : Submit To Manager [1.12]">
...
<node CREATED="1351785929804" ID="ID_1370309217" MODIFIED="1352495634042" TEXT="Can view a list of cross-functional impacts I have been tagged in : View My Impacts [1.14]">
...
<node CREATED="1351785029359" ID="ID_1657087345" MODIFIED="1352495637718" TEXT="Can view a summary report of all my budget impacts by and timing and objective : Budget Impact Reporting [1.17]"/>
...
<node CREATED="1351869627856" ID="ID_517724509" MODIFIED="1352495720148" TEXT="Can view aggregate reports of all the supporting objectives below me in the hierarchy : View Aggregate Reports [2.2]">
...
<node CREATED="1351870302357" ID="ID_1922551434" MODIFIED="1352495724015" TEXT="Can delegate the supporting objectives in my plan to any of my direct reports : Delegate Supporting Objectives [1.7, 1.17]"/>
<node CREATED="1351870711901" ID="ID_905804640" MODIFIED="1352495736648" TEXT="Can reject the plan that one of my direct reports has submitted to me for approval : Reject A Plan Submitted To Me [1.2]">
...
<node CREATED="1351870332223" ID="ID_1824278827" MODIFIED="1352495726847" TEXT="Can place the plan that one of my direct reports has submitted to me into draft approval : Move A Plan To Draft Approval [1.12]"/>
<node CREATED="1351870789633" ID="ID_1770802113" MODIFIED="1352495733641" TEXT="Can place the plan of one of my direct reports into final approval : Move A Plan To Final Approval [1.12]">
...
<node CREATED="1352495430264" ID="ID_1138589958" MODIFIED="1352496267662" TEXT="Am notified when one of my direct reports vacates their position and I must assume control of their plan : Notified For Vacated Positions [1.10]"/>
...
<node CREATED="1351871013034" ID="ID_836673577" MODIFIED="1352495761335" TEXT="Can view a report of all delinquent plan approvals throughout the company so that I can identify problem individuals and/or departments : View All Delinquent Plan Approvals [1.16,2.9]"/>
<node CREATED="1351871128477" ID="ID_151280189" MODIFIED="1352495774096" TEXT="Can view a report of all unresolved cross functional impacts throughout the company so that I can identify problem individuals and/or departments : View Unresolved Impacts [1.16,2.9]"/>
<node CREATED="1351871159380" ID="ID_924708135" MODIFIED="1352496405064" TEXT="Can make a change to any plan in the company regardless of plan state so that I can manually deal with exceptional circumstances : Manually Edit Any Plan [1.1]"/>
<node CREATED="1351871735375" ID="ID_1412924475" MODIFIED="1352495846272" TEXT="Can reassign an objective to a different position so that I can manage organization structure changes in the company : Re-assign Objectives [1.10]"/>
<node CREATED="1351871509441" ID="ID_936825126" MODIFIED="1352495860144" TEXT="Want all plans created by users to remain with their position if they change positions or are terminated so that the planning process is not disrupted : Plans Remain With A Positions [1.16]"/>
<node CREATED="1351871080323" ID="ID_727014975" MODIFIED="1352495766784" TEXT="Can send notifications to all users of the system : Send Notifications">
<node CREATED="1351871111157" ID="ID_1410287382" MODIFIED="1352495770663" TEXT="Can send notifications to specific individuals : Send Notification To User"/>
...
<node CREATED="1352132998208" ID="ID_319048758" MODIFIED="1352495882631" TEXT="Can give permission to any individual to view the ERM reports : Give Permissions To View ERM Reports [1.1]"/>
<node CREATED="1352132947347" ID="ID_449963614" MODIFIED="1352495897015" TEXT="Want all users to have permission to change only their plans : Users Can Change Only Their Plans [1.1]"/>
<node CREATED="1352132912953" ID="ID_1645726709" MODIFIED="1352495898956" TEXT="Want all plans to be locked after final approval (except for status updates) : Plans Are Locked After Final Approval [1.1,1.2]"/>
<node CREATED="1352133013813" ID="ID_893838315" MODIFIED="1352495902421" TEXT="Want all plans to be versioned : Plans Are Versioned [1.2]">
...
<node CREATED="1351871242565" ID="ID_628983206" MODIFIED="1352495804367" TEXT="Can rollback any plan for the current year in the system to a previous version : Rollback A Plan [1.2]"/>
</node>
...
<node CREATED="1351870967906" ID="ID_1508019407" MODIFIED="1352495874394" TEXT="Can initiate the S6 business plan, populating the objectives based on the corporate objectives for the company : Initiate S6 Plan With Objectives [1.3, 1.7]">
